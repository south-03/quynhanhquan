...
export default function Welcome() {
  return (
    <BnWelcome>
      <ContentContainer>
        <TitleWelcome>Welcome to our </TitleWelcome>
        <br />
        <TitleWelcome>beef noodle restaurant!</TitleWelcome>
        <br />
        <DWelcome>
          Unique flavors and a cozy atmosphere await you.
          <br />
          Come and enjoy it now!
        </DWelcome>

        <BtnDiscover>
          <ContentBtnD>Discover now</ContentBtnD>
          <br />
        </BtnDiscover>
      </ContentContainer>
      <ServiceImages>
